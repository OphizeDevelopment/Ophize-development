// Importing the background image asset
  ...
  return (
    <>
      <div className="md:mt-10 gap-10 justify-center flex md:flex-row flex-col md:px-24 px-10">
        ...
        <div className="text-white flex flex-col gap-4 md:items-start items-center mt-10 lg:w-[1020px] w-auto">
           {/* Subtitle */}
          ...
          <p className="xl:text-3xl xs2:text-xl tracking-wide md:text-start text-center">
           ...
           {/* Contact button */}
          <button
            className="capitalize bg-[#305197] px-5 py-2 sm:px-10 sm:py-3 rounded-lg text-white text-sm"
          >
            Contact us
          </button>
        </div>
         {/* Image container with layout adjustment for medium screens */}
        <div className="flex md:justify-normal justify-center md:mt-32">
          <img src={bg} alt="Digital Marketing" className="mt-5 md:w-auto w-80" />
        </div>
      </div>
    </>
  );
