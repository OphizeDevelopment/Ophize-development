    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 justify-center my-14 pb-0 2xl:w-[1440px] w-auto mx-auto">
        <div className="mx-9">
          <div className="p-5 ">
            ...
            <h1 className="md:text-2xl   font-bold  2xl:text-2xl 4xl:text-5xl md:text-start mt-3 xs:text-[30px]">
        ...
        <div className="mx-7 mt-6 mb-6 pl-1 text-start font-medium 2xl:text-2xl 4xl:text-3xl text-[18px] sm:text-xl md:text-base xs:text-lg">
          <div className="mx-9">
            <p className="">
              Our BPO services are not one-size-fits-all.We work with you to
              understand your unique challenges and create customized solutions
              that fit just right.
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-7 p-8 justify-center 2xl:w-[1440px] w-auto mx-auto mb-7">
        <div className="mx-9 flex flex-wrap">
          ...
          <h1 className="md:text-2xl   font-bold  2xl:text-2xl 4xl:text-5xl md:text-start mt-3 xs:text-[30px]mt-2 ">
            Streamlined Efficiency
          </h1>
          <p className="text-[14px] pt-3 2xl:text-xl 4xl:text-2xl sm:text-xl md:text-base xs:text-lg text-justify">
