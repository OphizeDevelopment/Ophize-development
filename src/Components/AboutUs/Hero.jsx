        ...
        <div className="grid grid-cols-1 md:grid-cols-2 justify-center my-14 2xl:w-[1440px] w-auto mx-14">
          <div className=" ">
            ...
            <div className=" flex flex-wrap gap-5">
              ...
              <h1 className="md:text-5xl xs2:text-3xl text-xl font-bold tracking-wide uppercase text-white md:text-start text-center">
                Empowering Your Business with Seamless Outsourcing Solutions
              </h1>
              <p className="text-white mb-5 md:text-3xl xs2:text-base text-sm text-center md:text-start">
